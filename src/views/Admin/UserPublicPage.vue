    ...
    >
      <div class="row mb-7">
        <div class="col-md mb-3 mb-md-0">
          ...
          <h1 class="mb-0">Usuarios Publicos</h1>
        </div>
        <!-- End Col -->

        <div class="col-md-auto align-self-md-end"></div>
        <!-- End Col -->
      </div>
      <!-- End Row -->
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-2 mb-2 mb-md-0">
                      <span
                        class="badge"
                        :class="
                          item.user ? 'text-bg-primary' : 'text-bg-danger'
                        "
                        >{{ item.user ? "REGISTRADO" : "SIN REGISTRO" }}</span
                      >
                    </div>
                  </div>
                </div>
...
const Sections = defineComponent({
  ...
  setup() {
    ...
    const deleteItem = async () => {
      loading.value = true;
      try {
        const response = await dispatch("users/delete", deleteId.value);
